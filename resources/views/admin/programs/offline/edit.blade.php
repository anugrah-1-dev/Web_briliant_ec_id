        ...
        <div class="container mt-4">
            ...
            <form action="{{ route('admin.offline.update', $offline->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama', $offline->nama) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug', $offline->slug) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('lama_program') is-invalid @enderror" name="lama_program" value="{{ old('lama_program', $offline->lama_program) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('kategori') is-invalid @enderror" name="kategori" value="{{ old('kategori', $offline->kategori) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('harga') is-invalid @enderror" name="harga" value="{{ old('harga', $offline->harga) }}">
                ...
                <div class="mb-3">
                    ...
                    @error('features_program') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                {{-- Lokasi --}}
                <div class="mb-3">
                    <label for="lokasi" class="form-label">Lokasi</label>
                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror" name="lokasi" value="{{ old('lokasi', $offline->lokasi) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('jadwal_mulai') is-invalid @enderror" name="jadwal_mulai" value="{{ old('jadwal_mulai', $offline->jadwal_mulai) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('jadwal_selesai') is-invalid @enderror" name="jadwal_selesai" value="{{ old('jadwal_selesai', $offline->jadwal_selesai) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('kuota') is-invalid @enderror" name="kuota" value="{{ old('kuota', $offline->kuota) }}">
                ...
                <div class="mb-3">
                    ...
                    @if ($offline->thumbnail)
                        <div class="mb-2">
                            <img src="{{ asset('uploads/thumbnails/' . $offline->thumbnail) }}" alt="Thumbnail" style="max-width: 200px;">
                        </div>
