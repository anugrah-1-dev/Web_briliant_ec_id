...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <x-adminlte-button label="Tambah Transportasi" theme="primary" icon="fas fa-plus" data-toggle="modal" data-target="#createTransportModal" />
    </div>
@stop
...
@section('content')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" id="searchInput" class="form-control" placeholder="Cari berdasarkan nama transportasi...">
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <form action="{{ route('admin.transports.destroy', $transport->id) }}" method="POST" onsubmit="confirmDelete(event)">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="dataTables_info">
                            Menampilkan {{ $transports->firstItem() }} sampai {{ $transports->lastItem() }} dari {{ $transports->total() }} entri
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    {{-- Modal Create --}}
    <x-adminlte-modal id="createTransportModal" title="Tambah Transportasi Baru" theme="lightblue" size="lg" static-backdrop>
    ...
    {{-- [MODAL EDIT] Modal Edit Transport --}}
