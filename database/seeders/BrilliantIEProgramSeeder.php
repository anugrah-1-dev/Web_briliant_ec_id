...
class BrilliantIEProgramSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $fasilitasBulan3 = array_merge(
            ['✅ 6 Kelas/Hari × 60 menit', '✅ Gratis kelas Prep TOEFL'],
            array_slice($fasilitasBulan2, 1) // semua kecuali item pertama yang sudah ditambahkan
        );
